  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Mobility with Car Rental: Streamline Your Carsharing Experience. Manage Profiles, Book Vehicles, Track Usage, and Assess Performance All in One Place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Mobility with Car Rental: Streamline Your Carsharing Experience. Manage Profiles, Book Vehicles, Track Usage, and Assess Performance All in One Place.`}
            </Text>
            <Box
